...
The (Batch_Size, Inner_Sub_Batch) operating-point ladder lived in the deleted tb_operating_point.py (see d124947); this
...
Usage (see --help):
    python gates/profile_fork.py phases                     # (a) + (d)
    python gates/profile_fork.py trace                      # (b)
    python gates/profile_fork.py all
