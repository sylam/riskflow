...
each run in their own process against their own code:
    ...
    GOLDEN_REPO=<repo-or-worktree> python gates/golden_worlds.py <world:Yes|No|sim> <out.pt>
    python gates/golden_worlds.py cmp <before.pt> <after.pt>
...
REPO = os.environ.get('GOLDEN_REPO', os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
