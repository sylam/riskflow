...
checkout to import riskflow from, so a baseline and a candidate each run against their own code.
    ...
    HERMITE_REPO=<repo-or-worktree> python gates/hermite_shared_stack.py <out.pt>
    python gates/hermite_shared_stack.py cmp <before.pt> <after.pt>
"""
import logging, os, sys, time

REPO = os.environ.get('HERMITE_REPO', os.path.dirname(os.path.dirname(os.path.abspath(__file__))))
