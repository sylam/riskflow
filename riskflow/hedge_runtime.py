...
def _normalize_optimizer_config(optimizer_config: Optional[Mapping[str, Any]]) -> Optional[Dict[str, Any]]:
    ...
    normalized = {
        ...
        "dense_tracking_reward_scale": float(optimizer_config.get("Dense_Tracking_Reward_Scale", 0.02)),
        "dense_tracking_reward_clip": float(optimizer_config.get("Dense_Tracking_Reward_Clip", 0.10)),
        ...
        "turnover_penalty_scale": float(optimizer_config.get("Turnover_Penalty_Scale", 1.5)),
