...
class ConstructMarkdown(object):
    ...
    mkdown = {'Theory':
        dict([
            ...
            ('Asset Pricing',
             ...
             '$$ \\alpha = \\frac{t - t_i}{t_{i + 1} - t_i} $$',
              ...
              '',
              'Interpolation across expiry is linear in volatility across all surfaces defined below. This may change '
              'to being linear in variance in future.'
              '',
              '### Sticky rule',
              '',
              'The Sticky Rule dictates the fixed volatility parameters that influence the retrieved volatility. '
              'The volatility value $v(x)$ for Skews and SVI surfaces is based on log - moneyness, which is defined '
              'differently depending on the sticky rule applied. These are:',
              '',
              ...
              '',
              'The right side of the curve with coefficients $\\alpha\', \\beta\', \\gamma\'$ are solved analogously '
              'but using $D, \\rho$ instead of $C, \\lambda$'
              '',
              '### SVI Surfaces',
              '',
              ...
              '',
              'Arbitrage constraints are not checked (will be implemented in future)',
              '',
              ...
              '### Explicit Surfaces',
              '',
              'These are moneyness surfaces (defined as either Spot over strike for equities or Forward over strike '
              'for FX). These moneyness surfaces must have the moneyness axis strictly greater than 1.0. Volatility is '
              'then linearly interpolated across moneyness.'
              ]),
        ...
        'Valuation': dict([
            ...
            ('Container', ['Container deals are deals that potentially post-process the results of dependent deals'])
        ]),
        'Boostrapping': dict([
            ('General',
