"""GARCH-world 48-trade corridor RE-ROLL (throwaway; tb_ prefix, untracked, no commit).
...
os.environ.setdefault('TB_BASE', os.path.join(os.path.dirname(os.path.abspath(__file__)),
                                              'artifacts', 'walk_forward', 'garch48_corridor'))
...
LANES_SRC = [(f'{WF}/garch48_gpu0', '2020-01'), (f'{WF}/garch48_gpu1', '2022-01')]
...
def main():
    ...
    ap.add_argument('--base', default=os.path.join(WF, 'garch48_corridor'))
    args = ap.parse_args()
